...
function fillTableBody(pageInfo) {
	...
	for (var i = 0; i < pageInfo.list.length; i++) {
		...
		var pencilBtn = "<button type='button' roleId='" + roleId + "' class='btn btn-primary btn-xs pencilBtn'><i class='glyphicon glyphicon-pencil'></i></button>";
...
// 		$("#removeNodeSpan").append(roleName + "<br/>");
// 		var roleId = role.roleId;
// 		// 调用数组对象的push()方法存入新元素
// 		window.roleIdArray.push();
// 	}
// }
