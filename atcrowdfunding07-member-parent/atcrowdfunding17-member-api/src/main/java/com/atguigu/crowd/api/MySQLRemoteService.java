...
@FeignClient("atguigu-crowd-mysql") // 指定远程调用的应用名称
public interface MySQLRemoteService {
    ...
    ResultEntity<String> saveProjectVORemote(@RequestBody ProjectVO projectVO,@RequestParam("loginacct") Integer memberId);
